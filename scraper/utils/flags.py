...
_ALIASES: dict[str, tuple[str, str]] = {
    ...
    "Adelaide":               ("Adelaide",               _F["Australia"]),
    "Baku":                   ("Baku",                   _F["Azerbaijan"]),
    "Barber":                 ("Barber",                 _F["United States"]),
    "Bathurst":               ("Bathurst",               _F["Australia"]),
    "Barcelona":              ("Barcelona",              _F["Spain"]),
    "Beijing":                ("Beijing",                _F["China"]),
    "Berlin":                 ("Berlin",                 _F["Germany"]),
    "Brands Hatch":           ("Brands Hatch",           _F["Great Britain"]),
    "Budapest":               ("Budapest",               _F["Hungary"]),
    "Chile":                  ("Chile",                  _F["Chile"]),
    "COTA":                   ("Austin",                 _F["United States"]),
    "Fuji":                   ("Fuji",                   _F["Japan"]),
    "Daytona":                ("Daytona",                _F["United States"]),
    "Detroit":                ("Detroit",                _F["United States"]),
    "Hidden Valley":          ("Hidden Valley",          _F["Australia"]),
    "Hungaroring":            ("Budapest",               _F["Hungary"]),
    "Indianapolis":           ("Indianapolis",           _F["United States"]),
    "Islas Canarias":         ("Las Palmas",             _F["Spain"]),
    "Italia":                 ("Italy",                  _F["Italy"]),
    "Jeddah":                 ("Jeddah",                 _F["Saudi Arabia"]),
    "Laguna Seca":            ("Laguna Seca",            _F["United States"]),
    "Las Vegas":              ("Las Vegas",              _F["United States"]),
    "London":                 ("London",                 _F["Great Britain"]),
    "Long Beach":             ("Long Beach",             _F["United States"]),
    "Lusail":                 ("Lusail",                 _F["Qatar"]),
    "Madrid":                 ("Madrid",                 _F["Spain"]),
    "Madring":                ("Madrid",                 _F["Spain"]),
    "Magny-Cours":            ("Magny-Cours",            _F["France"]),
    "Mandalika":              ("Mandalika",              _F["Indonesia"]),
    "Melbourne":              ("Melbourne",              _F["Australia"]),
    "Mexico City":            ("Mexico City",            _F["Mexico"]),
    "Miami":                  ("Miami",                  _F["United States"]),
    "Misano":                 ("Misano",                 _F["Italy"]),
    "Monaco":                 ("Monaco",                 _F["Monaco"]),
    "Monte Carlo":            ("Monte Carlo",            _F["Monaco"]),
    "Monte-Carlo":            ("Monte Carlo",            _F["Monaco"]),
    "Montreal":               ("Montreal",               _F["Canada"]),
    "Monza":                  ("Monza",                  _F["Italy"]),
    "Mosport":                ("Mosport",                _F["Canada"]),
    "Nürburgring":            ("Nürburgring",            _F["Germany"]),
    "Okayama":                ("Okayama",                _F["Japan"]),
    "Paul Ricard":            ("Paul Ricard",            _F["France"]),
    "Phillip Island":         ("Phillip Island",         _F["Australia"]),
    "Portimão":               ("Portimão",               _F["Portugal"]),
    "Queensland Raceway":     ("Queensland Raceway",     _F["Australia"]),
    "Red Bull Ring":          ("Spielberg",              _F["Austria"]),
    "Road America":           ("Road America",           _F["United States"]),
    "Road Atlanta":           ("Road Atlanta",           _F["United States"]),
    "Sakhir":                 ("Bahrain",                _F["Bahrain"]),
    "Sanya":                  ("Sanya",                  _F["China"]),
    "Sao Paulo":              ("São Paulo",              _F["Brazil"]),
    "São Paulo":              ("São Paulo",              _F["Brazil"]),
    "Sebring":                ("Sebring",                _F["United States"]),
    "Sepang":                 ("Sepang",                 _F["Malaysia"]),
    "Shanghai":               ("Shanghai",               _F["China"]),
    "Silverstone":            ("Silverstone",            _F["Great Britain"]),
    "Singapore":              ("Singapore",              _F["Singapore"]),
    "Sonoma":                 ("Sonoma",                 _F["United States"]),
    "Spa":                    ("Spa",                    _F["Belgium"]),
    "Suzuka":                 ("Suzuka",                 _F["Japan"]),
    "Spa-Francorchamps":      ("Spa",                    _F["Belgium"]),
    "Sydney Motorsport Park": ("Sydney Motorsport Park", _F["Australia"]),
    "The Bend":               ("The Bend",               _F["Australia"]),
    "Tokyo":                  ("Tokyo",                  _F["Japan"]),
    "VIR":                    ("VIR",                    _F["United States"]),
    "Watkins Glen":           ("Watkins Glen",           _F["United States"]),
    "Yas Marina":             ("Abu Dhabi",              _F["United Arab Emirates"]),
    "Zandvoort":              ("Zandvoort",              _F["Netherlands"]),
